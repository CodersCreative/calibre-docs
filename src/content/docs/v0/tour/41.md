...
In everyday code, raw\_add and raw\_done should not be used as its generally better standard to combine them together using `.join` or using by using a `spawn {...}` block.
